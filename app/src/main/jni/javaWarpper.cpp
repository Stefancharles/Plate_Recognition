...
Java_com_stefan_platerecognition_utils_PlateRecognition_InitPlateRecognizer(
...
Java_com_stefan_platerecognition_utils_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jclass obj,
...
Java_com_stefan_platerecognition_utils_PlateRecognition_ReleasePlateRecognizer(JNIEnv *env,
                                                                               jclass obj,
                                                                  jlong object_re) {
